...
grep -o -P -m 1 "Latest Version\: \d\.\d\.\d\.\d" | cut -f 3 -d ' ')

if [ ! -e $MODSLUG-$MOD_VERSION.zip ]
then
    wget -q https://dl.dropboxusercontent.com/u/57416963/Minecraft/Mods/CoFHCore/release/CoFHCore-$MOD_VERSION.jar \
    -O mods/CoFHCore-$MOD_VERSION.jar
