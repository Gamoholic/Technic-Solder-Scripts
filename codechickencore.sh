...
cd coremods
wget --trust-server-names -q http://www.chickenbones.craftsaddle.org/Files/goto.php?file=CodeChickenCore\&version=1.5.1
MOD_VERSION=$(ls | grep -o -P "\d\.\d\.\d\.\d")
cd ..
